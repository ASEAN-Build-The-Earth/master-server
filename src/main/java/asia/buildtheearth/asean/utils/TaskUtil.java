...
public final class TaskUtil {
    ...
    @NotNull
    public static <T> Task<T> timeout(@NotNull MasterServer plugin, @NotNull Task<T> future, @NotNull Duration timeout) {
        ScheduledFuture<?> scheduledFuture = plugin.scheduler().runLater(() -> {
            if (!future.isDone()) {
