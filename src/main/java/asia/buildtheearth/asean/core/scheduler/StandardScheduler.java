...
package asia.buildtheearth.asean.core.scheduler;

import asia.buildtheearth.asean.MasterServer;
import asia.buildtheearth.asean.core.scheduler.executor.DynamicCachingThreadPoolExecutor;
import asia.buildtheearth.asean.core.scheduler.threadfactory.CountingForkJoinWorkerThreadFactory;
import asia.buildtheearth.asean.core.scheduler.threadfactory.CountingThreadFactory;
    ...
    private Runnable wrap(Runnable runnable) {
        return () -> {
            try {
                ...
                MasterServer.error(Thread.currentThread().getName() + " ran into an exception", t);
            }
        };
    }
